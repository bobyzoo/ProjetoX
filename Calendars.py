...
class Calendar():
    def __init__(self):
        ...
        self.Holiday = {'AnoNovo' : '01-01', 'Carnaval' : '04-03', 'Paixao' : '19-04', 'Tiradentes' : '21-04', 'Trabalho' : '01-05', 'CorpusChristi' : '20-06', 'Independencia' : '07-09', 'NossaSenhora' : '12-10', 'Finados' : '02-11', 'Proclamacao' : '15-11', 'Natal' : '25-12'}
